...
και να αναπτυχθει το καθενα αναλυτικα -->
### Πίνακας Περιπτώσεων Χρήσης

| Κωδικός                                            | Τίτλος                  | Περιγραφή                                                    |
|----------------------------------------------------|--------------------------|--------------------------------------------------------------|
| [ΠΧ1](.docs/markdown/use-case_upload.md)           | Δημιουργία Λογαριασμού   | Ο χρήστης εγγράφεται στο xChange και δημιουργεί προφίλ       |
...
| [ΠΧ4](.docs/markdown/use-case_trade.md)            | Συναλλαγή Ανταλλαγής     | Ο χρήστης στέλνει αίτημα για ανταλλαγή αντικειμένου με άλλον χρήστη |
...
| [ΠΧ7](.docs/markdown/use-case_trade_management.md) | Αποδοχή ή Απόρριψη Αιτήματος Ανταλλαγής | Ο αποδέκτης επιλέγει να αποδεχτεί, να απορρίψει ή να κάνει αντιπρόταση στο αίτημα |
