...
2. Firebase, το οποίο χρησιμοποιείται για την βάση δεδομένων, χρήση αναλυτικών και παροχή διαφόρων βοηθειών όπως ταυτοποίηση χρηστών.
3. Gitlab, το οποίο περιέχει όλα τα αρχεία του project που χρησιμοποιεί η ομάδα που επιτρέπει την εύκολη διαχείρισή τους.
