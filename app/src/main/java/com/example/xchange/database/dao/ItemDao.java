...
public interface ItemDao {
    ...
    @Query("SELECT * FROM items WHERE LOWER(item_name) LIKE '%' || LOWER(:query) || '%' AND LOWER(item_category) = LOWER(:categoryStr)")
    List<Item> searchItemsByNameAndCategory(String query, String categoryStr);
